...
I spent years on Archlinux, I loved the experience, it's a distribution I love and that puts you in control, but I got tired of its rolling release model. The packages are too close to the upstream for my taste and there is no dependency isolation. By that I mean that it's a traditional system, very nice, but things tend to break too often for me. I spent some time on Bluefin, the fork of Silverblue, to end up on Fedora Minimal. I want to have Secureboot and SELinux, the reliability of Fedora packages and the fact that there is Redhat behind it gives me total confidence in the reliability of the distribution.
